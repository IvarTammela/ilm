...
if(navigator.geolocation){navigator.geolocation.getCurrentPosition(function(p){window.location.href='?lat='+p.coords.latitude+'&lon='+p.coords.longitude},function(){window.location.href='?linn=tallinn'})}else{window.location.href='?linn=tallinn'}
